...
openai_api_key = "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"
...
gr.Interface(fn=generate_cover_letter, inputs=inputs, outputs=output).launch(server_name="0.0.0.0", server_port= 7867, share=True)